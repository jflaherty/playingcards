...
import com.github.jflaherty.cardgames.playingcards.IDeck;
...
public class Deck implements IDeck, Iterable<Card> {

	protected static final String MSG_DECK_EMPTY = "Deck is empty.";
